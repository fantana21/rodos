...
in
  ...
  ["on-posix64" stdenv]
  ["discovery" pkgs.gcc-arm-embedded.stdenv]
  ["discovery_f429" pkgs.gcc-arm-embedded.stdenv]
  ["skith" pkgs.gcc-arm-embedded.stdenv]
  ["raspberrypi3" pkgs.gcc-arm-embedded.stdenv]
  ["sf2" pkgs.gcc-arm-embedded.stdenv]
  ]
